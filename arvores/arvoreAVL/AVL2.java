...
public class AVL2 extends ABP implements ArvoreAVL {
    ...
    public Object remover(Object o) {
        ...
        if (pontoBalanceamento != null) {
            altFBremocao(pontoBalanceamento);
        }
